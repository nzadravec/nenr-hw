...
public class GaussMutation implements IMutation<double[]> {
	...
	public GaussMutation(double pm, double constant) {
		this(pm, constant, -Double.MAX_VALUE, Double.MAX_VALUE);
	}

	public GaussMutation(double pm, double constant, double minBound, double maxBound) {
		super();
		this.pm = pm;
