...
public class GenerationalGATest {
	...
	private static final int NUM_GENS = 10_000;
	private static final int POP_SIZE = 20;
	private static final boolean elitism = true;
	
	private static final double pm = 0.1;
	
	private static final ISelection<double[]> selection = new RouletteWheelSelection<>();
	...
	public static void main(String[] args) {
		...
		if(plot) {
		    ...
		    chart.pack( );
		    RefineryUtilities.positionFrameOnScreen(chart, 0, 0);//( chart );
